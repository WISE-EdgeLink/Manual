...
3. Open the PLC communication software at the control center to configure the PLC.(The communication software connects to 10.3.20.18 to configure PLC1 that is connected to Gateway 1)
