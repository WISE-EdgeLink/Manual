...
> VCOM 管理程序安装包下载链接：[VCOM Utility](https://www.advantech.tw/support/details/utility?id=1-24KJ5E7){target="_blank"}
...
VCOM 管理程序是独立的安装包，官网的下载页面为：[VCOM Utility](https://www.advantech.tw/support/details/utility?id=1-24KJ5E7){target="_blank"}，选择其中的 SetupEdgeLinkVCOM 开头字样的安装包下载即可。
